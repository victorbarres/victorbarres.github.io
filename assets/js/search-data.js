...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-three-τ-bench-family-papers-accepted-to-icml-2026-including-τ-bench-as-an-oral-slides-τ-bench-dual-control-evaluation-τ-knowledge-knowledge-retrieval-and-τ-voice-full-duplex-voice-agents-see-you-in-july",
          title: 'Three τ-Bench family papers accepted to ICML 2026 — including τ²-Bench as an...',
          description: "",
